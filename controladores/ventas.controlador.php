	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($respuesta == "ok"){
				...
				// $printer -> text("DJ Company Vape"."\n");//Nombre de la empresa

				// // $printer -> text("NIT: 71.759.963-9"."\n");//Nit de la empresa

				// $printer -> text("Dir: Calle Ramon Javier Batista, Villa Carmen. "."\n");//Dirección de la empresa

				// $printer -> text("Teléf: 829-757-1807/809-761-9901"."\n");//Teléfono de la empresa

				// $printer -> text("FACTURA N.".$_POST["nuevaVenta"]."");//Número de factura
				...
				// $printer -> text("Vendedor: ".$traerVendedor["nombre"]."");//Nombre del vendedor
				...
				// $printer->text("TOTAL: $ ".number_format($_POST["totalVenta"],2).""); //ahora va el total
